<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- First Name -->
        <div>
            <x-input-label for="Fname" class="mt-2" :value="__('First Name')" />
        ...
        <!-- Last Name -->
        <div>
            <x-input-label for="Lname" class="mt-2" :value="__('Last Name')" />
        ...
        <!-- Personal Number -->
        <div>
            <x-input-label for="pnumber" class="mt-2" :value="__('Phone Number')" />
            <x-text-input id="pnumber" class="block mt-1 w-full" type="text" name="pnumber" :value="old('pnumber')" required autofocus autocomplete="pnumber" />
